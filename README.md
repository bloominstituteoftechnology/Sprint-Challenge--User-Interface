...
the building blocks to the display for a webpage

2. Name two big differences between ```display: block;``` and ```display: inline;```.
block is displayed as a block, as paragraphs have always been. it has whitespace above and below it. inline is inside the current block on the same line.
...
share coding across different users and add comments.
