...
I would say that Semantic HTML is simply to add meaning to your website.

2. What are the 4 areas of the box model?
The four area of the box model are margin, border, padding and content.
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
The axis is vertical meaning that flexbox items will be centered vertically.
4. Explain why git is valuable to a team of developers.
Git is valuable to a team of developers because it is collaboration friendly. Users are able to create their own branch of work that will not disrupt the work flow of other on the team. 

5. Define mobile-first design in your own words?
Mobile-first design is essentially mapping out a prototype for the smallest screen for a  website you create. It insures the website is user friendly for phones and tablets. 
