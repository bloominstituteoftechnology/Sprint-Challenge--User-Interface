...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic in HTML is used to make changes to the text.

2. Name two big differences between ```display: block;``` and ```display: inline;```

    display block allows us to set width and height on the element.
...
5. Explain why git is valuable to a team of developers.
    ...
    git helps keep track of the developers' code and making sure that their codes are compatible with one another.
