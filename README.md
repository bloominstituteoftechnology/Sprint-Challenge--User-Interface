...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    ...
    display:block -  the element will occupy the entire width of the page; can employed width and height.

    display:inline - the element will occupy only as much width as its content; height and width have no effect
