...
Semantic Html is the html markup using tags and Html content to construct the DOM of your HTML page.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

```display: block;```: takes up 100% of width where ```display: inline;```: wraps you content.

3. What are the 4 areas of the box model?

The 4 areas are Top, bottom, left, and right.
...
keeps code organized and allows for multiple versions of the same code.
