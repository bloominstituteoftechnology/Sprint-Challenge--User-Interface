...
Tags that give meaning to a webpage, rather than just presentation or looks.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

display block will take a full width of 100% by default while display inline only takes as much space as it needs.
...
Git allows us to save and share different versions of our code so that we can work independently or together.
