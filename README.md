...
Semantic HTML or semantic markup is HTML that introduces meaning to the page rather than presentation. Like the <p> tag, when used, it tells you that the enclosed text is a paragraph and its also presentational. <div> which is commonly used to divide parts of the site it doesn't give much meaning. Semantic elements have more meaning like <article> or <section> <nav>.
...
Git is valuable to a team of developers because it allows the developers or team
to collaborate and contribute efficiently and effectively. its important because it also records a history of everything contributed and recording the history helps to fix mistakes.
