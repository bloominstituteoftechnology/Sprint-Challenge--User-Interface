...
Display: Block elements break past inline elements and take up as much horizontal space as they can.
Display:inline is the default value for elements such as <span>,<em>,or <b>. Wrapping in those elements will not break the flow of the line.
