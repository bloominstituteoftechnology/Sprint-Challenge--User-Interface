- [x] ## Task 1: Set Up The Project With Git
  - [x] Fork the project into your GitHub user account
  - [x] Clone the forked project into a directory on your machine
  - [x] You are now ready to build this project with your preferred IDE


- [x] ## Task 2: Comprehension Questions
  - [x] 1. If you had to describe semantic HTML to the next cohort of students, what would you say?
  - [x] 2. Describe some differences between ```display: block;``` and ```display: inline;```.
  - [x] 3. What are the 4 areas of the box model?
  - [x] 4. While using flexbox, what axis are you using when you use the property: ```align-items: center```?
  - [x] 5. What is the git command to commit staged changes as well as write a message?
