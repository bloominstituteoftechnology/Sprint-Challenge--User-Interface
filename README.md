...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic HTML adds meaning to your code.
...
4. Explain why git is valuable to a team of developers.
   Git allows teams of developers to be able to see each version of your code and reference previous versions of the code.

5. Define mobile-first design in your own words.
   When you make a prototype of a website you start with a wireframe of the smallest screen.
