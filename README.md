...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
     - Semantic HTML is giving meaning to HTML element.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
     - Two big difference ```display: block;``` and ```display: inline;``` are:
       a) display block will display the element in colunm mode.
       b) Display inline will display the element in row mode.
