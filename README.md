...
Semantic HTML is a way to give your HTML description and meaning. It makes it easy to know what you are referring to.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block will create a new section such as a p element, and inline block will continue on, such as an a element.
...
Git allows the team to edit, and save code, move it around, save old versions in case something breaks they can go back to the old versioun. 
