...
Display block causes an inline element to have properties of a block element. While display inline does the opposite. it removes block properties or keeps the original settings.
