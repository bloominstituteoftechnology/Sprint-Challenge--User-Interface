...
Semantic HTML describes the elements on the page easier for other developers and ESO.
2. What are the 4 areas of the box model?
The 4 areas of the box model are Content,Padding,Margin, and Border.
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
align-items: center; is working on the cross axis, if using row that is the vertical.  If using column it is the horizontal.
4. Explain why git is valuable to a team of developers.
It allows a team to work independantly on different branches of code and to cooperate on a single application.  It also saves every version for future reference.
5. Define mobile-first design in your own words.
Mobile-first design means starting from a mobile width design and working up to tablet and desktop design through breakpoints from media queries
