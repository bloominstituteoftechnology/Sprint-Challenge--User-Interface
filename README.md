...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? A way of identifying the meaning on elements on the page.

2. Name two big differences between ```display: block;``` and ```display: inline;```. Block is the only element that can be placed on a line, and inline does not have a height or width that you can add.
...
5. Explain why git is valuable to a team of developers. You have version control for the team of developers.
