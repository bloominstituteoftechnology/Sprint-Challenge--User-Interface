...
Semantic is the process of providing meaning to your content.



2. Name two big differences between ```display: block;``` and ```display: inline;```.

 display:inline; takes up as much space as it's content. display: block; starts on a new line;
...
git allowse the team of developers to work on a project at the same time.
