...
* HTML tags describe the meaning of the section in the page context. Accessibility works perfect with semantic HTML, humans may not understand what ```<div>``` but they would understand what ```<article>``` is. These tags has meaning to each of them.
