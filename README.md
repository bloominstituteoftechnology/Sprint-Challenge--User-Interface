...
Sematic HTML is the process of providing meaning to your content. 
...
git is valuable because it controle and keep changes that were made by diffrent people. 

5. Define mobile-first design in your own words.

mobile-first is design means the website has been designed to apper and function on mobile with smaller screen. 
