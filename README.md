...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Coding in a way that is readable and logical at face value.
...
5. Explain why git is valuable to a team of developers.
    Above all else, it allows collaboration across individuals and teams, any time and any where. Iteration can be rapid
