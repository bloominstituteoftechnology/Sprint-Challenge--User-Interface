...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    - i would just describe it as the structure of your HTML and what holds all of the content, individually(p, h tags) and together. (sections, div tags)

2. Name two big differences between ```display: block;``` and ```display: inline;```.
    - block always starts on a new line, but takes up that whole line and inline does not start a new line and takes up the only space necessary.
...
5. Explain why git is valuable to a team of developers.
    - It is very convenient when code needs to be shared amongst developers, or it needs to be reviewed/revised. 
