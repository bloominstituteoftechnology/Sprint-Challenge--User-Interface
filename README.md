...
Semantic HTML is html tags with meaning. You can just look at the tag and know what it's for like <header>, <body>, <footer> and the paragraph tag <p>.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display: block displays content as block, like a paragraph. Display: inline displays content all on one line.
...
Git is valuable to a team of developers because it allows the members of the team to individually work on a project simultaneously and then be able to merge their work together.
