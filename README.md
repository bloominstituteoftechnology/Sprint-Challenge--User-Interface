...
Semantic html is html that is as descriptive as possible so people will know exactly what it is.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

Display block will use a block of space. Display block will take up the whole with of the page.
Display inline will have all elements in line and will be inside of a block on the same line.

3. What are the 4 areas of the box model?

the four areas are padding, margin, border and content.
...
Git allows developers to collaborate on the same code and contribute their work as a team.
