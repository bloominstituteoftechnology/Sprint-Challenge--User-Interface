// let memory = document.querySelector('main').innerHTML;
// memory;
// document.querySelectorAll('ul li a')
// document.querySelector('main').innerHTML = `  <img class="flex-inline flex-justify-around" src="img/jumbo.jpg">
...
// <div class="flex flex-wrap flex-justify-around">
